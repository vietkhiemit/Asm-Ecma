            ...
            <div class="flex items-center">
              ...
              <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-4">
                  ...
                  <a href="/#/admin/user" class=" text-white hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium" aria-current="page">User</a>
                  ...
                  <a href="/#/admin/contact" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Contact</a>
                ...
                <div class="ml-3 relative">
                  <div>
                    <button type="button" class="max-w-xs bg-gray-800 rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                      ...
                      <img class="h-8 w-8 rounded-full" src="https://scontent.fhan5-4.fna.fbcdn.net/v/t39.30808-6/273894234_652965985942029_2055423428952019454_n.jpg?_nc_cat=104&ccb=1-5&_nc_sid=8bfeb9&_nc_ohc=P69U5BCX4oYAX_2N_BS&_nc_ht=scontent.fhan5-4.fna&oh=00_AT-alvv65y1_CYPsMfNo98Ti9vNVYJwrr_207RCXR9M5Mw&oe=621649ED" alt="">
                    </button>
                  </div>
